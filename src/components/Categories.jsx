export default function Categories() {
  return (
    <>
      <div className="w-full mt-10 p-6 lg:p-32">
        <div className="class w-full">
          <h1 className="text-center text-4xl font-medium py-2">
            Our Categories
          </h1>
        ...
        <div className="w-full py-10 grid gap-6 md:grid-cols-2">
          <div className="h-[270px] md:h-[300px] lg:h-[450px]  relative ">
            <div className="w-full h-[85%] bg-black  border-2  border-black rounded-[25px] overflow-hidden">
              ...
              />
              <div className="absolute w-[90%] h-[100px] left-1/2 -translate-x-1/2 bg-white shadow-lg rounded-[25px] bottom-0">
                <div className="flexn justify-center items-center">
                  <h1 className="text-center my-3 text-xl font-medium">
                    Mens Wear
                  </h1>
          ...
          <div className="h-[270px] md:h-[300px] lg:h-[450px]  relative ">
            <div className="w-full h-[85%] bg-black  border-2  border-black rounded-[25px] overflow-hidden">
              ...
              <div className="absolute w-[90%] h-[100px] left-1/2 -translate-x-1/2 bg-white shadow-lg rounded-[25px] bottom-0">
                <div className="flexn justify-center items-center">
                  <h1 className="text-center my-3 te  xt-xl font-medium">
                    Womens Wear
                  </h1>
                  <div className="text-center text-red-500 hover:text-black">
                    Shop Now
